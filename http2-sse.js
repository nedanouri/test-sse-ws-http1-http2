...
const serverRoot = "./public/http2-sse";
...
server = http.createSecureServer(options, (req, res) => {
	...
	if (req.pathname == "/all") {
		...
		res.writeHead(200, {
		  ...
		  //'Connection': 'keep-alive'	==> http/2 does not need this header
		});
...
console.log("Testing SSE over http/2 (SSL)");
